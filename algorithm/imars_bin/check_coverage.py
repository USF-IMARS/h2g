...
#        mime2cmd = ['h5dump', '-H', ifile]
#        mime2 = subprocess.Popen(mime2cmd, stdout=subprocess.PIPE).communicate()[0]
        ...
        elif (re.search('Hierarchical.*version.5', mime) or re.search('data', mime)):
